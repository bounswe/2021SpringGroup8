    ...
    render() {
        ...
        return (
            <div className="sidebar">
                ...
                <SidebarOption active={activeOption === "Explore"} Icon={SearchIcon} text="Explore"
                               onClick={handleClick}/>
                <SidebarOption active={activeOption === "Communities"} Icon={NotificationsNoneIcon} text="Communities"
                               onClick={handleClick}/>
                {communities && communities.map((community, index) => (
                    <SubSidebarOption active={activeOption === community.CommunityTitle} Icon={NotificationsNoneIcon}
                                      text={community.CommunityTitle} onClick={handleClick}/>
                ))}
                <SidebarOption active={activeOption === "Messages"} Icon={MailOutlineIcon} text="Messages"
                               onClick={handleClick}/>
                {/*<SidebarOption Icon={BookmarkBorderIcon} text="Bookmarks"/>*/}
                <SidebarOption active={activeOption === "Lists"} Icon={ListAltIcon} text="" onClick={handleClick}/>
                <SidebarOption active={activeOption === "Profile"} Icon={PermIdentityIcon} text="Profile"
                               onClick={handleClick}/>
